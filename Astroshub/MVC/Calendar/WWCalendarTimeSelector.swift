...
open class WWCalendarTimeSelector: UIViewController, UITableViewDelegate, UITableViewDataSource, WWCalendarRowProtocol, WWClockProtocol {
    ...
    open var optionCalendarBackgroundColorTodayHighlight = UIColor(red: 256/255.0, green: 123/255.0, blue: 24/255.0, alpha: 1.0)
    ...
    open var optionCalendarBackgroundColorPastDatesHighlight = UIColor(red: 256/255.0, green: 123/255.0, blue: 24/255.0, alpha: 1.0)
    ...
    open var optionCalendarBackgroundColorFutureDatesHighlight = UIColor(red: 256/255.0, green: 123/255.0, blue: 24/255.0, alpha: 1.0)
    open var optionCalendarBackgroundColorFutureDatesFlash = UIColor.white
    open var optionCalendarUnderlinedBackgroundColor = UIColor(red: 256/255.0, green: 123/255.0, blue: 24/255.0, alpha: 1.0)
    ...
    open var optionClockBackgroundColorAMPMHighlight = UIColor(red: 256/255.0, green: 123/255.0, blue: 24/255.0, alpha: 1.0)
    ...
    open var optionClockBackgroundColorHourHighlight = UIColor(red: 256/255.0, green: 123/255.0, blue: 24/255.0, alpha: 1.0)
    open var optionClockBackgroundColorHourHighlightNeedle = UIColor(red: 256/255.0, green: 123/255.0, blue: 24/255.0, alpha: 1.0)
    ...
    open var optionClockBackgroundColorMinuteHighlight = UIColor(red: 256/255.0, green: 123/255.0, blue: 24/255.0, alpha: 1.0)
    open var optionClockBackgroundColorMinuteHighlightNeedle = UIColor(red: 256/255.0, green: 123/255.0, blue: 24/255.0, alpha: 1.0)
    ...
    open var optionButtonFontColorCancel = UIColor(red: 256/255.0, green: 123/255.0, blue: 24/255.0, alpha: 1.0)
    open var optionButtonFontColorDone = UIColor(red: 256/255.0, green: 123/255.0, blue: 24/255.0, alpha: 1.0)
    open var optionButtonFontColorCancelHighlight = UIColor(red: 256/255.0, green: 123/255.0, blue: 24/255.0, alpha: 1.0).withAlphaComponent(0.25)
    open var optionButtonFontColorDoneHighlight = UIColor(red: 256/255.0, green: 123/255.0, blue: 24/255.0, alpha: 1.0).withAlphaComponent(0.25)
    ...
    open var optionTopPanelBackgroundColor = UIColor(red: 256/255.0, green: 123/255.0, blue: 24/255.0, alpha: 1.0)
    ...
    open var optionSelectorPanelBackgroundColor = UIColor(red: 256/255.0, green: 123/255.0, blue: 24/255.0, alpha: 1.0).withAlphaComponent(0.9)
    ...
    fileprivate var tintColor : UIColor! = UIColor(red: 31/255.0, green: 130/255.0, blue: 162/255.0, alpha: 1.0)
